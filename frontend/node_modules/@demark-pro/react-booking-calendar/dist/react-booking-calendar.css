...
.calendar__calendar-container:not([data-scrollable]) .calendar__month-content[data-some-month] span:first-child {
  color: #007aff;
}

.calendar__calendar-container:not([data-scrollable]) .calendar__month-content[data-some-year] span:nth-child(2) {
  color: #007aff;
}
...
.calendar__calendar-container[data-scrollable] .calendar__month-content span:nth-child(2) {
  font-size: 0.9rem;
  font-weight: 400;
}

.calendar__calendar-container[data-scrollable] .calendar__month-content[data-some-year] span:nth-child(2) {
  display: none;
}
...
.calendar__month-arrow-back svg,
...
.calendar__calendar-container[data-scrollable] .calendar__day-container[data-selected][data-start-month] .calendar__day-selection,
.calendar__calendar-container[data-scrollable] .calendar__day-container[data-reserved][data-start-month] .calendar__day-reservation,
...
.calendar__calendar-container[data-scrollable] .calendar__day-container[data-selected][data-end-month] .calendar__day-selection,
.calendar__calendar-container[data-scrollable] .calendar__day-container[data-reserved][data-end-month] .calendar__day-reservation,
